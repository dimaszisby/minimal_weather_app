...
class SlidingUpPanelExample extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return MaterialApp(
      ...
      home: SlidingUpPanelExamplePage(),
    );
  }
}

class SlidingUpPanelExamplePage extends StatefulWidget {
  @override
  _SlidingUpPanelExamplePageState createState() => _SlidingUpPanelExamplePageState();
}

class _SlidingUpPanelExamplePageState extends State<SlidingUpPanelExamplePage> {
