...
import '../../lib/data/datasources/remote_data_source.dart' as _i9;
import '../../lib/data/failure.dart' as _i7;
import '../../lib/data/models/current_weather_model.dart'as _i3;
import '../../lib/domain/entities/current_weather.dart' as _i8;
import '../../lib/domain/repositories/weather_repository.dart'as _i5;
...
class _FakeWeatherModel_1 extends _i1.Fake implements _i3.CurrentWeatherModel {}
...
class MockWeatherRepository extends _i1.Mock implements _i5.WeatherRepository {
  ...
  @override
  _i6.Future<_i2.Either<_i7.Failure, _i8.CurrentWeather>> getCurrentWeather(
          double? lon, double? lat) =>
      (super.noSuchMethod(Invocation.method(#getCurrentWeather, [lon, lat]),
              returnValue: Future<_i2.Either<_i7.Failure, _i8.CurrentWeather>>.value(
                  _FakeEither_0<_i7.Failure, _i8.CurrentWeather>()))
          as _i6.Future<_i2.Either<_i7.Failure, _i8.CurrentWeather>>);
  @override
...
class MockRemoteDataSource extends _i1.Mock implements _i9.RemoteDataSource {
  ...
  @override
  _i6.Future<_i3.CurrentWeatherModel> getCurrentWeather(double? lon, double? lat) =>
      (super.noSuchMethod(Invocation.method(#getCurrentWeather, [lon, lat]),
              returnValue:
                  Future<_i3.CurrentWeatherModel>.value(_FakeWeatherModel_1()))
          as _i6.Future<_i3.CurrentWeatherModel>);
  @override
  String toString() => super.toString();
}
